#!/usr/bin/env python3
"""
Fix primary keys for memories, intentions, plans, and summaries tables to use composite keys.

This script alters the existing tables to use composite primary keys:
- memories: (id, agent_telegram_id)
- intentions: (id, agent_telegram_id)
- plans: (id, agent_telegram_id, channel_id)
- summaries: (id, agent_telegram_id, channel_id)
"""
