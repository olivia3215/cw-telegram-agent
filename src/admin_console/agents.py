...
from pathlib import Path
partners_module_path = Path(__file__).parent / "agents" / "partners.py"
spec = importlib.util.spec_from_file_location("admin_console_agents_partners", partners_module_path)
partners_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(partners_module)
