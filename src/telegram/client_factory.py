# src/telegram/client_factory.py
#
# Copyright (c) 2025-2026 Cindy's World LLC and contributors
# Licensed under the MIT License. See LICENSE.md for details.
#
"""
Factory functions for creating Telegram clients.
"""
...
def get_telegram_client(agent_config_name: str, phone_number: str) -> TelegramClient:
    """
    Create and return a TelegramClient for an agent.
    
    Args:
        agent_config_name: The agent's configuration name
        phone_number: The phone number associated with the agent
        
    Returns:
        A configured TelegramClient instance
        
    Raises:
        RuntimeError: If required environment variables or parameters are missing
    """
...
def get_puppet_master_client() -> TelegramClient:
    ...
    Returns:
        A configured TelegramClient instance for the puppet master
