...
- **Conversations** — Conversation management with subtabs:
  ...
  - **Events** — View and manage scheduled events (future actions with optional recurrence). Conversations that have events show an asterisk (*) in the partner list. Date-time is shown in the agent's timezone; create, edit (auto-save), and delete events.
